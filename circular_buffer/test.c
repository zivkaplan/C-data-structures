...
#include "circular_buffer.h" /* Create(), Destroy(), Write(), Read() */
...
void RunTest(void)
{
    ...
    ret_val = CircBuffRead(circ_buff, stack_buff, 3);

    PrintTest(ret_val, 0, "Read", __LINE__);
    PrintTest(CircBuffCapacity(circ_buff), 6, "Capacity", __LINE__);
    PrintTest(CircBuffIsEmpty(circ_buff), 1, "IsEmpty", __LINE__);
    PrintTest(CircBuffFreeSpaceLeft(circ_buff), 6, "FreeSpaceLeft", __LINE__);

    printf(BOLDWHITE "\nWriting 2 bytes to buffer\n" RESETCOLOR);
    ret_val = CircBuffWrite(circ_buff, "hi", 2);

    PrintTest(ret_val, 2, "Write", __LINE__);
    PrintTest(CircBuffCapacity(circ_buff), 6, "Capacity", __LINE__);
    ...
    ret_val = CircBuffRead(circ_buff, stack_buff, 2);

    PrintTest(ret_val, 2, "Read", __LINE__);
    PrintTest(CircBuffCapacity(circ_buff), 6, "Capacity", __LINE__);
    PrintTest(CircBuffIsEmpty(circ_buff), 1, "IsEmpty", __LINE__);
    PrintTest(CircBuffFreeSpaceLeft(circ_buff), 6, "FreeSpaceLeft", __LINE__);
    ...
    ret_val = CircBuffWrite(circ_buff, "full-buffer", 10);

    PrintTest(ret_val, 6, "Write", __LINE__);
    PrintTest(CircBuffCapacity(circ_buff), 6, "Capacity", __LINE__);
    PrintTest(CircBuffIsEmpty(circ_buff), 0, "IsEmpty", __LINE__);
    PrintTest(CircBuffFreeSpaceLeft(circ_buff), 0, "FreeSpaceLeft", __LINE__);

    printf(BOLDWHITE "\nWriting to a full buffer\n" RESETCOLOR);
    ret_val = CircBuffWrite(circ_buff, "123", 3);

    PrintTest(ret_val, 0, "Write", __LINE__);
    PrintTest(CircBuffCapacity(circ_buff), 6, "Capacity", __LINE__);
    PrintTest(CircBuffIsEmpty(circ_buff), 0, "IsEmpty", __LINE__);
    PrintTest(CircBuffFreeSpaceLeft(circ_buff), 0, "FreeSpaceLeft", __LINE__);

    printf(BOLDWHITE "\nReading 6 bytes of buff\n" RESETCOLOR);
    ret_val = CircBuffRead(circ_buff, stack_buff, 10);

    PrintTest(ret_val, 6, "Read", __LINE__);
    PrintTest(CircBuffCapacity(circ_buff), 6, "Capacity", __LINE__);
    PrintTest(CircBuffIsEmpty(circ_buff), 1, "IsEmpty", __LINE__);
    PrintTest(CircBuffFreeSpaceLeft(circ_buff), 6, "FreeSpaceLeft", __LINE__);
